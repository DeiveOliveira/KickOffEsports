...
//                                mvcMatherBuilder.pattern("/auth/login"),mvcMatherBuilder.pattern("/cadastro"),
//                                mvcMatherBuilder.pattern("/cadastrar"),
//                                mvcMatherBuilder.pattern("/editar/**"),
//                                mvcMatherBuilder.pattern("/editarUsuario/**"),
//                                mvcMatherBuilder.pattern("/listaDeUsuario"),
//                                mvcMatherBuilder.pattern("/listaDeUsuario")).permitAll()
//                        .requestMatchers(mvcMatherBuilder.pattern("/telaPrincipal")).authenticated()
